...
public class AccountManager {
    ...
    public Account register(String username, String email, String password) {
        ...
        if (pass_hash != null && pass_hash.equals("")) return null;
        ...
        try {
            ...
            if (!manager.executeUpdate(sqlQueryStatement,conn)) return null;
            ...
            if (rslt!=null&&rslt.next()) {
                ...
                if (!addToStatsTable(id)) return null;
    ...
    public boolean removeAccount(int id) {
        ...
        if (!checkAvaliability(sqlQueryStatement)) return false;
    ...
    public boolean change(String old_username, String old_email, String username, String email) {
        ...
        if (!checkAvaliability(sqlQueryStatement)) return false;
        if (existsUsername(username) || existsEmail(email)) return false;
    ...
    public boolean change(String oldOne,  String newOne, String attribute) {
        if (newOne == null || attribute == null) return false;
    ...
    private boolean checkAvaliability(String sqlQueryStatement) {
        ...
        try {
            ...
            if (rslt == null || !rslt.next()) return false;
            return true;
        } catch (SQLException e) {
            e.printStackTrace();
            return false;
    ...
    public boolean setPassword(String oldpass, String newpass, int id) {
        ...
        if (new_hash == null || (old_hash != null && old_hash.equals("")) || new_hash.equals("")) return false;
    ...
    public boolean sendValidate(String username, String email, String password) {
        ...
        if (g_services.sendMail(messageTOMail,email,"ProChess Email Verification")) {
            if (simpleExecuteUpdate(sqlQueryStatement)) return true;
        }
        return false;
    }
            ...
            if (rslt != null && rslt.next()) {
                ...
                if (acc != null) {
                    sqlQueryStatement = "delete from validations\n" +
                            "  where email=\"" + email + "\";";
                    if (simpleExecuteUpdate(sqlQueryStatement)) return acc;
                }
            }
            return null;
        } catch (SQLException e) {
