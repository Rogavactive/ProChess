...
<head>
    ...
    <!--my styles-->
    <link rel="stylesheet" href="css/puzzles.css" type="text/css" media="screen"/>
    <link rel="stylesheet" href="css/style.css" type="text/css" media="screen"/>
    <link rel="stylesheet" href="css/animate.css"/>
    <script type="text/javascript" src="js/puzzles.js"></script>
    <!--google-->
    ...
    <%@ page import="Puzzles.Model.databaseConnection" %>
    <%
        ...
        String puzzleID = request.getParameter("id");
        int puzzle_id = 1;
        if(puzzleID!=null){
            puzzle_id = Integer.parseInt(puzzleID);
        }
    %>
    <script>
